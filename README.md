...
minimalista y tecnológico, con animaciones suaves y rendimiento optimizado.

## Stack

- **React 19 + Vite 8** — UI y build
- **Tailwind CSS v4** — estilos
- **Framer Motion** — animaciones (scroll-reveal, parallax, modal, preloader)
- **Lucide** — iconos (+ 1 icono de marca propio en `src/components/icons.jsx`)
- **EmailJS** — formulario de contacto (sin backend)

## Secciones

Inicio (foto + typewriter + redes + CV) · Sobre mí · Tecnologías (9 skills con niveles) ·
Certificación QA · Contacto (EmailJS + modal) — y `Projects.jsx` lista pero **comentada**
hasta publicar los repositorios.
...
> cargá las mismas variables como *secrets* del repositorio.
